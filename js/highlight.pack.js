...
skip:!0})]}]})})());hljs.registerLanguage("scss",(()=>{"use strict";return e=>{var t="@[a-z-]+",i={
...
name:"Less",case_insensitive:!0,illegal:"[=>'/<($\"]",contains:a}}})());hljs.registerLanguage("css",(()=>{"use strict";return e=>{
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})());hljs.registerLanguage("yaml",(()=>{"use strict";return e=>{
...
aliases:["yml","YAML"],contains:b}}})());hljs.registerLanguage("apache",(()=>{"use strict";return e=>{const n={
...
name:"TypeScript",aliases:["ts"]}),b}})());hljs.registerLanguage("bash",(()=>{"use strict";function e(...e){
